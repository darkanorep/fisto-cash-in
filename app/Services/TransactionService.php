...
class TransactionService
{
    ...
    private function buildTransactionData(array $data, array $additionalFields = []): array
    {
        $baseData = [
            ...
            'customer_code'           => $data['customer']['code'] ?? $data['customer_code'],
            ...
            'bank_name'               => $data['bank']['name'] ?? $data['bank_name'],
            'check_no'                => $data['cheque']['no'] ?? $data['check']['no'] ?? $data['cheque_no'],
            'check_date'              => $data['cheque']['date'] ?? $data['check']['date'] ?? $data['cheque_date'],
            'amount'                  => $data['amount'] ?? null,
            'remaining_balance'       => $data['remaining_balance'] ?? 0,
            'charge_id'               => $data['charge']['id'] ?? null,
            'charge_name'             => $data['charge']['name'] ?? null,
